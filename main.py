...
class MainApp(App):
    ...
    def build(self):
        ...
        layout2.add_widget(skobkaon)

        skobkaoff = Button(text=")", pos_hint={"center_x": 0.5, "center_y": 0.5})
        skobkaoff.bind(on_press=self.on_button_press)
        layout2.add_widget(skobkaoff)

        eq_button = Button(text="=", pos_hint={"center_x": 0.5, "center_y": 0.5})
